...
const { requiredRule, positiveAmountRule: positiveRule } = useValidationRules()
        ...
        <v-card v-else border flat rounded="lg">
          <v-table data-testid="data-table" density="comfortable">
            <thead class="bg-grey-lighten-4">
              <tr>
                <th class="text-uppercase text-caption font-weight-bold text-grey-darken-1" scope="col">
                  {{ $t('settings.thresholds.currency') }}
                </th>
                <th class="text-uppercase text-caption font-weight-bold text-grey-darken-1" scope="col">
                  {{ $t('settings.thresholds.approvalThreshold') }}
                </th>
                <th class="text-uppercase text-caption font-weight-bold text-grey-darken-1 text-center" scope="col"
                  style="width: 100px">
                  {{ $t('common.actions') }}
                </th>
              </tr>

                  ...
                  <div class="d-flex flex-column">
                    ...
                    <template v-if="isChangesObject(value)">
                      <v-table class="mt-1 rounded bg-grey-lighten-4" density="compact">
                        <thead>
                          <tr>
                            <th class="text-caption font-weight-bold" style="width: 30%">
                              {{ $t('auditLogs.detail.field') }}
                            </th>
                            <th class="text-caption font-weight-bold" style="width: 35%">
                    ...
                    <template v-else-if="isChangeEntry(value)">
                      <div class="mt-1 d-flex align-center ga-2">
                        <span class="text-caption text-red-darken-2">{{ formatValue((value as { from: unknown }).from) }}</span>
                        <v-icon color="grey" icon="mdi-arrow-right" size="14" />
                        <span class="text-caption text-green-darken-2">{{ formatValue((value as { to: unknown }).to) }}</span>
                      </div>
                    </template>
